                         ...
                         ?>
                            <div class="media mb-3" >
                                ...
                                <div class="media-body">
                                    ...
                                    <p><a href="conversation.php?supplier_id=<?php echo $row['supplier_id']; ?>" style="color: black;"><?php echo $row['supplier_name']; ?></a></p>
                                    <small class="text-muted" style="margin-left: 30px;">Posted by <?php echo $row['customer_name']; ?> on <?php echo $row['cdate']; ?></small>
                                </div>
                            </div>
                            <hr>
                        <?php } ?>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <?php 
                                                if(isset($_POST['submitrequest']))
                                                {
                                                        ...
                                                        $query = mysqli_query($con, "INSERT INTO `tblrequestcustomer`(`customer_id`, `supplier_id`, `content`, `cdate`) VALUES ('$customer_id', '$supplier_id', '$content', '$tdate')");
