<div class="modal fade bs-example-modal-md" id="bd-example-modal-sm<?php echo $row['customer_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          <form class="form-material" method="POST">
                                                            ...
                                                            <h3>Do you want to block this customer?</h3>
                                          <!-- </form> -->
                            ...
                            <?php 
                                    if(isset($_POST['update']))
                                    {
                                        ...
                                        $query = mysqli_query($con, "UPDATE `tblcustomer` SET `active`= 0 WHERE customer_id = '$id'");

                                        echo "<script>window.location.replace('customerlist.php')</script>";
                                    }
                             ?>
            </div>