...
<body>
    ...
    <div id="pcoded" class="pcoded">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Pending Transaction</h5>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Pending Transaction</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
        ...
        <tbody>
          <?php 
            ...
            $query = mysqli_query($con, "SELECT *, tblmaintransaction.reference_id as reference, SUM(amount) as amount, tblmaintransaction.reference_id as mainRef FROM tblmaintransaction INNER JOIN tblshippingrate ON tblshippingrate.shippingrate_id=tblmaintransaction.shippingrate_id INNER JOIN tblsupplier ON tblsupplier.supplier_id=tblshippingrate.supplier_id INNER JOIN tblcustomer ON tblcustomer.customer_id=tblmaintransaction.customer_id WHERE tblsupplier.supplier_id = '$id' AND tblmaintransaction.status_id = 1 GROUP BY tblmaintransaction.reference_id");
           ...
           ?>
            <tr>
                ...
                <td align="center">
                    <a href="#" class="btn-sm btn-primary" data-toggle="modal" data-target="#bd-example-modal-sm<?php echo $row['transaction_id']; ?>" type="button">
                            ...
                            <a href="deliverytransaction.php?reference=<?php echo $row['mainRef']; ?>&supplier_id=<?php echo $id; ?>&customer=<?php echo $row['customer_name']; ?>" class="btn-sm btn-success" type="button">
                            <i class="fa fa-check"></i>
                            </a> 
                            <a href="#" class="btn-sm btn-danger" data-toggle="modal" data-target="#bd-example-modal-sm1<?php echo $row['transaction_id']; ?>" type="button">
            ...
            <?php include('../modals/modalCanceltransaction.php'); ?>
    ...
    <div class="modal fade bs-example-modal-md" id="exampleModal<?php echo $transaction_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
