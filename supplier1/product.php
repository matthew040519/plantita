          ...
          <?php 
           ...
           ?>
            <tr>
                ...
                <td><button data-toggle="modal" data-target="#bd-example-modal-sm<?php echo $row['product_id']; ?>" class="btn waves-effect waves-light btn-success btn-sm btn-outline-success"><i class="icofont icofont-check"></i>Update Product</button></td>
                <!-- <td>61</td>
                <td>2011/04/25</td>
                <td>$320,800</td> -->
            </tr>
            <?php include('modals/modalupdateproduct.php'); ?>
          <?php } ?>
          </tbody>
        </table>
                                                    </div>
