                                                                        ...
                                                                        <td>
                                                                            <div class="d-inline-block align-middle">
                                                                                ...
                                                                                <div class="d-inline-block">
                                                                                    <h6><a href="conversation.php?customer_id=<?php echo $row['customer_id']; ?>"><?php echo $row['customer_name']; ?></a></h6>
                                                                                    <p class="text-muted m-b-0"><?php echo $row['cdate']; ?></p>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <!-- <td class="text-right">
