                                                                        ...
                                                                        <td>
                                                                            <form method="POST">
                                                                                <div class="form-group">
                                                                                    <label>Reply</label>
                                                                                    <textarea cols="3" name="content" class="form-control"></textarea>
                                                                                </div>
                                                                                <!-- <div class="modal-footer"> -->
                                           <!--  <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button> -->
                                            <!-- <button type="button" class="btn btn-primary">Save changes</button> -->
                                            <input type="submit" class="btn btn-primary" style="float: right;" value="Send" name="submitrequest">
                                        <!-- </div> -->
                                                                            </form>
                                                ...
                                                if(isset($_POST['submitrequest']))
                                                {
                                                        ...
                                                        $query = mysqli_query($con, "INSERT INTO `tblrequestcustomer`(`customer_id`, `supplier_id`, `content`, `cdate`, `sendby`) VALUES ('$customer_id', '$supplier_id', '$content', '$tdate', 'Supplier')");

                                                        echo "<script>window.location.replace('conversation.php?customer_id=".$customer_id."')</script>";
                                                }
                                         ?>
                                                                        </td>
                                                                    </tr>
