...
<body>
    ...
    <div id="pcoded" class="pcoded">
        ...
        <tbody>
          <?php 
            $query = mysqli_query($con, "SELECT * FROM tblproductransact INNER JOIN tblproducts on tblproducts.product_id=tblproductransact.product_id WHERE tblproducts.active = 1 AND tblproducts.supplier_id = $id");
    ...
    <div class="modal fade bs-example-modal-md" id="bd-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                            ...
                            <?php 
                                    if(isset($_POST['submit']))
                                    {
                                        ...
                                        $query = mysqli_query($con, "INSERT INTO `tblproductransact`(`prod_transact_id`, `product_id`, `tdate`, `Pout`, `PIn`, `supplier_id`, `reference_id`) VALUES (NULL, '$product', '$tdate', 0, '$qty', '$id', '$randomString')");
