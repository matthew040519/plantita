                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Return Product Transaction</h5>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Return Product Transaction</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                            ...
                                            <div class="col col-sm-6 mt-4">
                                                <input type="submit" class="btn btn-success" value="Search" name="search">
                                                    ...
                                                    <div class="card-header">
                                                        <h5>Return Product Transaction</h5>
          ...
          <?php 
           ...
           ?>
            <tr>
                ...
                <td><?php echo $row['return_desc']; ?></td>
                <td align="center">
