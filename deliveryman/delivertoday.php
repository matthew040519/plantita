                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Delivery Today Transaction</h5>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Delivery Today Transaction</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                                    ...
                                                    <div class="card-header">
                                                        <h5>Delivery Today Transaction</h5>
        ...
        <tbody>
          ...
          // echo $tdate;
            ...
            while($row = mysqli_fetch_array($query)){
                ...
                $apipass = "[!h4stk{y1";
                                    $msg = $customer_name." your order with Reference ".$reference." will deliver today!";
                                    $number = $contactno;
           ...
           ?>
            <tr>
                ...
                <td align="center">
                    <a href="#" class="btn-sm btn-primary" data-toggle="modal" data-target="#bd-example-modal-sm<?php echo $row['transaction_id']; ?>" type="button">
                            ...
                            <a href="deliverytransaction.php?id=<?php echo $id; ?>&supplier_id=<?php echo $supplier_id; ?>&reference=<?php echo $row['reference']; ?>" class="btn-sm btn-success" type="button">
                            <i class="fa fa-money"></i>
                            </a> 
                            <a href="#" data-toggle="modal" data-target="#bd-example-modal-sm1<?php echo $row['transaction_id']; ?>" class="btn-sm btn-secondary" type="button">
            ...
            <?php include('../modals/modalReturnItems.php'); ?>
          <?php } ?>
          </tbody>
        </table>
                                                    </div>
