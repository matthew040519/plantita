                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Block Customer List</h5>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Block Customer List</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                    ...
                                                    <table id="example" class="table table-striped" style="width:100%">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><button data-toggle="modal" data-target="#bd-example-modal-sm<?php echo $row['customer_id']; ?>" class="btn waves-effect waves-light btn-success btn-sm btn-outline-success"><i class="fa fa-cancel"></i>UnBlock Customer</button></td>
                                                            </tr>
                                                        <?php include('../modals/modalUnBlock.php'); ?>
                                                        <?php } ?>
