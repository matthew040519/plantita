                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Active Customer List</h5>
                                                    ...
                                                    <table id="example" class="table table-striped" style="width:100%">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><button data-toggle="modal" data-target="#bd-example-modal-sm<?php echo $row['customer_id']; ?>" class="btn waves-effect waves-light btn-danger btn-sm btn-outline-danger"><i class="fa fa-cancel"></i>Block Customer</button></td>
                                                            </tr>
                                                        <?php include('../modals/modalConfirmation.php'); ?>
                                                        <?php } ?>
