                                               ...
                                               <!-- <div class="card-block table-border-style">
                                                <div> -->
                                                    <table id="example" class="table table-striped" style="width:100%">
                                                        ...
                                                        <tbody>
                                                            <?php 
                                                                $query = mysqli_query($con, "SELECT * FROM `tblsupplier` WHERE active = 1");
                                                            ...
                                                            <tr>
                                                                ...
                                                                <!-- <td><a class="btn btn-success btn-sm" href="accept.php?id=<?php echo $row['supplier_id']; ?>">Accept</a> || <a class="btn btn-danger btn-sm" href="decline.php?id=<?php echo $row['supplier_id']; ?>">Decline</a></td> -->
                                                            </tr>
                                                        <?php } ?>
