                             ...
                             <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                              <div class="col-md-6" >
                                                        <div class="card text-center order-visitor-card" style="height: 300px;">
                                                            <div class="card-block">
                                                                <?php 
                                                                        $query = mysqli_query($con, "SELECT COUNT(*) as count from tblsupplier WHERE active = 1");
                                                                        $row = mysqli_fetch_array($query);
                                                                 ?>
                                                                <h6 class="m-b-0" style="font-size: 48px;">Total Supplier</h6>
                                                                <h4 class="m-t-15 m-b-15" style="font-size: 48px; margin-top: 50px;"><i class="fa fa-users m-r-15 text-c-red"></i><?php echo $row['count']; ?></h4>
                                                      ...
                                                      <div class="col-md-6">
                                                        <div class="card text-center order-visitor-card" style="height: 300px;">
                                                            <div class="card-block">
                                                                <?php 
                                                                        $query = mysqli_query($con, "SELECT COUNT(*) as count from tbltown");
                                                                        $row = mysqli_fetch_array($query);
                                                                 ?>
                                                                <h6 class="m-b-0" style="font-size: 48px;">Total Town</h6>
                                                                <h4 class="m-t-15 m-b-15" style="font-size: 48px; margin-top: 50px;"><i class="fa fa-building m-r-15 text-c-red"></i><?php echo $row['count']; ?></h4>
                                                                <!-- <p class="m-b-0">36% From Last 6 Months</p> -->
                                                            </div>
                                                        </div>
                                                    </div>
                                                      <div class="col-md-6">
                                                        <div class="card text-center order-visitor-card" style="height: 300px;">
                                                            <div class="card-block">
                                                                <?php 
                                                                        $query = mysqli_query($con, "SELECT COUNT(*) as count from tbldistributor WHERE active = 1");
                                                                        $row = mysqli_fetch_array($query);
                                                                 ?>
                                                                <h6 class="m-b-0" style="font-size: 48px;">Total Distributor</h6>
                                                                <h4 class="m-t-15 m-b-15" style="font-size: 48px; margin-top: 50px;"><i class="fa fa-users m-r-15 text-c-red"></i><?php echo $row['count']; ?></h4>
                                                                <!-- <p class="m-b-0">36% From Last 6 Months</p> -->
                                                            </div>
                                                        </div>
                                                       ...
                                                       <div class="card text-center order-visitor-card" style="height: 300px;">
                                                            <div class="card-block">
                                                                <?php 
                                                                        ...
                                                                        $row = mysqli_fetch_array($query);
                                                                 ?>
                                                                <h6 class="m-b-0" style="font-size: 48px;">Total Customer</h6>
                                                                <h4 class="m-t-15 m-b-15" style="font-size: 48px; margin-top: 50px;"><i class="fa fa-user m-r-15 text-c-red"></i><?php echo $row['count']; ?></h4>
                                                                <!-- <p class="m-b-0">36% From Last 6 Months</p> -->
                                                            </div>
                                                        </div>
                                                    </div>
