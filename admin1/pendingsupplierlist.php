                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Supplier List</h5>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Supplier List</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                               ...
                                               <!-- <div class="card-block table-border-style">
                                                <div> -->
                                                    <table id="example" class="table table-striped" style="width:100%">
                                                        ...
                                                        <tbody>
                                                            <?php 
                                                                $query = mysqli_query($con, "SELECT * FROM `tblsupplier` WHERE active = 0");
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a class="btn btn-success btn-sm" href="accept.php?id=<?php echo $row['supplier_id']; ?>&supplier=<?php echo $row['supplier_name']; ?>&number=<?php echo $row['contact_no']; ?>">Accept</a> || <a class="btn btn-danger btn-sm" href="decline.php?id=<?php echo $row['supplier_id']; ?>&supplier=<?php echo $row['supplier_name']; ?>&number=<?php echo $row['contact_no']; ?>">Decline</a></td>
                                                            </tr>
                                                        <?php } ?>
