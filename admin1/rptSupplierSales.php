                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Supplier Sales Report</h5>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Supplier Sales Report</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <?php if(isset($_POST['search'])){
                                         ...
                                         ?>
                                                    ...
                                                    <div class="card-header">
                                                        <h5>Supplier: <?php echo $rowSupplierSales['supplier_name']; ?></h5>
                                                        <div class="card-header-right">
                                                            <h5>Total Sales: <?php echo number_format($rowSupplierSales['amount'] + $rowSupplierSales['shippingrate'], 2) ?></h5>
                                                             ...
                                                             <a target="_blank" href="pdfsuppliersales.php?id=<?php echo $supplier_id; ?>" class="btn waves-effect waves-light btn-primary btn-sm btn-outline-primary">Export PDF</a>
