                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Pending Customer List</h5>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Pending Customer List</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                                    ...
                                                    <div class="card-header">
                                                        <h5>Pending Customer List</h5>
                                                        <div class="card-header-right">
                                                           <!--   <button style="margin-right: 10px;" data-toggle="modal" data-target="#bd-example-modal-sm" class="btn waves-effect waves-light btn-primary btn-sm btn-outline-primary"><i class="icofont icofont-plus"></i>Add Supplier</button> -->
                                               ...
                                               <!-- <div class="card-block table-border-style">
                                                <div> -->
                                                    <table id="example" class="table table-striped" style="width:100%">
                                                        ...
                                                        <tbody>
                                                            <?php 
                                                                $query = mysqli_query($con, "SELECT * FROM `tblcustomer` WHERE active = 0");
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a target="_blank" class="btn btn-primary btn-sm" href="../uploaded_files/<?php echo $row['uploaded_file']; ?>">Preview File</a></td>
                                                                 <td><a class="btn btn-success btn-sm" href="acceptcustomer.php?id=<?php echo $row['customer_id']; ?>&customer=<?php echo $row['customer_name']; ?>&number=<?php echo $row['contact_no']; ?>">Accept</a> || <a class="btn btn-danger btn-sm" href="declinecustomer.php?id=<?php echo $row['customer_id']; ?>&customer=<?php echo $row['customer_name']; ?>&number=<?php echo $row['contact_no']; ?>">Decline</a></td>
                                                            </tr>
                                                        <?php } ?>
