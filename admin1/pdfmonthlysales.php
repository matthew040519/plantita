<?php 
	...
	class PDF extends FPDF
	{
		function header()
		{
    		...
    		$this->Text(70,23,'Monthly Sales Report');
    		$this->Ln(20);
		}
		function footer()
		{
	...
	$query = mysqli_query($con, "SELECT tdate, supplier_name, customer_name, reference, amount,  shippingrate, totalAmt FROM `suppliersales` WHERE date_deliver BETWEEN '$bdate' AND '$edate'");
